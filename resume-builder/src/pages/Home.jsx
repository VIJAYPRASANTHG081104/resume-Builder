            ...
            <Row>
              <Col lg='8'>
                <div className='resume__content mt-5'>
                  <h1 className='titleh1'>Resume
                    <span className='highlight'>Builder</span>
                  </h1>
                  <p className='para__1'>Build beautiful resumes in a few clicks!<br /> Our resume builder is  easy to use, with a range of <br />amazing functions. can generate resumes within minutes.<br />
                  </p>
                </div>
            ...
            <Row className='d-flex align-items-center gap-5'>
              ...
              <Col lg='5'>
                <div className='resume__content2 mt-5'>
                  ...
                  <p className='para__1 mt-5'>We have developed a resume builder , The goal is simple: help you land that dream job interview! Get an advantage in the modern professional environment.</p>
                </div>
